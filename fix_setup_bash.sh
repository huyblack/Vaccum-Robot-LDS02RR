...
# Thay thế đường dẫn media mount point thành đường dẫn chuẩn
sed -i 's|/media/huy/ae10c4f5-cc7d-4491-b724-c470b97c9693/opt/ros/humble|/opt/ros/humble|' "$SETUP_BASH_PATH"
