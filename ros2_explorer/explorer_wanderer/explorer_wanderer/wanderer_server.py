    ...
    for y in range(height):
        for x in range(width):
            ...
            if map_array[idx] <= free_thresh and map_array[idx] > -1:
                # Kiểm tra 4 hàng xóm (trái, phải, trên, dưới)
...
class WandererServer(Node):
    ...
    def __init__(self):
        ...
        self.frontier_count = 1  # Khởi tạo >0 để bắt đầu
        self.frontier_threshold = 5 
    ...
    def execute_callback(self, goal_handle):
        ...
        while self.frontier_count >= self.frontier_threshold:
        ...
        self.get_logger().info('Wandering Finished (no more frontier)')
        goal_handle.succeed()
